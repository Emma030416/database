## 目录
- [SQL语言的分类](#sql语言的分类)
  - [1. DDL：数据定义语言](#1-ddl数据定义语言)
  - [2. DML：数据操作语言](#2-dml数据操作语言)
  - [3. DCL：数据控制语言](#3-dcl数据控制语言)
- [SQL语言的规则和规范](#sql语言的规则和规范)
  - [1. 分号结尾](#1-分号结尾)
  - [2. 大小写问题](#2-大小写问题)
  - [3. 命名规则（暂时了解）](#3-命名规则暂时了解)
  - [4. 注释](#4-注释)
  - [5. 数据导入](#5-数据导入)
- [基本的SELECT语句](#基本的select语句)
  - [1. SELECT...](#1-select)
  - [2. SELECT... FROM](#2-select-from)
  - [3. 列的别名](#3-列的别名)
  - [4. 去除重复行](#4-去除重复行)
  - [5. 空值NULL](#5-空值null)
  - [6. 着重号](#6-着重号)
